...
public class ResultActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Integer imageFileID[] = {R.drawable.blur, R.drawable.bright,
                R.drawable.btn_star_big_on, R.drawable.dark, R.drawable.gray,
                R.drawable.rotate, R.drawable.web, R.drawable.zoom_in,
                R.drawable.zoom_out};
        ...
        for (int j=0;j<voteResult.length;j++){
            tv[j].setText(imageName[i]);
            rbar[j].setRating((float) voteResult[i]);
        }
