...
public class MainActivity extends AppCompatActivity {
    ImageButton ibZoomin,ibZoomout,ibRotate,ibBright,ibDark,ibBlur,ibEmbo;
    ...
    private void clickIcons(){
        ...
        ibEmbo=(ImageButton) findViewById(R.id.ibEmbo);
        ibEmbo.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                embos=!embos;
                graphicView.invalidate();
            }
    ...
    private static class MyGraphicView extends View {
        ...
        protected void onDraw(Canvas canvas){
            ...
            paint.setColorFilter(new ColorMatrixColorFilter(cm));
            Bitmap picture = BitmapFactory.decodeResource(getResources(),R.drawable.web);
